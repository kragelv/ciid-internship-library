...
public interface BookService {
    ...
    List<Book> getAllBooksIcnludeAuthorAndGenres();

    Book getBookById(UUID bookId);

    Book getBookByIdIcnludeAuthorAndGenres(UUID bookId);

    void updateBook(UUID bookId, String title, UUID authorId, Integer publishedYear, Integer availableCopies, List<String> genres);

    void updateBookWithGenreIds(UUID bookId, String title, UUID authorId, Integer publishedYear, Integer availableCopies, List<UUID> genreIds);
