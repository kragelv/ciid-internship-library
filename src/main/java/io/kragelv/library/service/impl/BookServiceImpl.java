...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book createBook(String title, UUID authorId, Integer publishedYear, Integer availableCopies,
            List<String> genres) {
    ...
    @Override
    public List<Book> getAllBooksIcnludeAuthorAndGenres() {
        return bookDAO.getAllBooksIncludeAuthorAndGenres();
    }

    @Override
    public Book getBookByIdIcnludeAuthorAndGenres(UUID bookId) {
        return bookDAO.getByIdIncludeAuthorAndGenres(bookId)
    ...
    @Override
    public void updateBookWithGenreIds(UUID bookId, String title, UUID authorId, Integer publishedYear, Integer availableCopies,
            List<UUID> genreIds) {
        Optional<Book> existingBook = bookDAO.getById(bookId);
        if (existingBook.isEmpty()) {
            throw new BookNotFoundException(bookId);
